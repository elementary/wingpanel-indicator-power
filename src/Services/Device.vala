...
const int DEVICE_STATE_UNKNOWN = 0;
const int DEVICE_STATE_CHARGING = 1;
const int DEVICE_STATE_DISCHARGING = 2;
const int DEVICE_STATE_EMPTY = 3;
const int DEVICE_STATE_FULLY_DISCHARGED = 4;
const int DEVICE_STATE_PENDING_CHARGE = 5;
const int DEVICE_STATE_PENDING_DISCHARGE = 6;

const int DEVICE_TECHNOLOGY_UNKNOWN = 0;
const int DEVICE_TECHNOLOGY_LITHIUM_ION = 1;
const int DEVICE_TECHNOLOGY_LITHIUM_POLYMER = 2;
const int DEVICE_TECHNOLOGY_LITHIUM_IRON_PHOSPHATE = 3;
const int DEVICE_TECHNOLOGY_LEAD_ACID = 4;
const int DEVICE_TECHNOLOGY_NICKEL_CADMIUM = 5;
const int DEVICE_TECHNOLOGY_NICKEL_METAL_HYDRIDE = 6;

const int DEVICE_TYPE_UNKNOWN = 0;
const int DEVICE_TYPE_LINE_POWER = 1;
const int DEVICE_TYPE_BATTERY = 2;
const int DEVICE_TYPE_UPS = 3;
const int DEVICE_TYPE_MONITOR = 4;
const int DEVICE_TYPE_MOUSE = 5;
const int DEVICE_TYPE_KEYBOARD = 6;
const int DEVICE_TYPE_PDA = 7;
const int DEVICE_TYPE_PHONE = 8;
